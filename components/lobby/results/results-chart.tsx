...
export default function ResultsChart({ results, factors }: ResultsChartProps) {
  ...
  // Mostriamo tutti i candidati se sono pochi, max 5 se tanti
  const activeCandidates = results.slice(0, 6)

  // Nota: Abbiamo rimosso la Card container con overflow-hidden
  return (
    <div className="w-full h-[400px] text-xs">
